...
privileged aspect AMET_PIIRIPUNKTISController_Roo_Controller {
    ...
    public String AMET_PIIRIPUNKTISController.create(@Valid AMET_PIIRIPUNKTIS AMET_PIIRIPUNKTIS, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        return "redirect:/amet_piiripunktiss/" + encodeUrlPathSegment(AMET_PIIRIPUNKTIS.getAmet_piiripunktis_id().toString(), httpServletRequest);
    }
    ...
    @RequestMapping(value = "/{amet_piiripunktis_id}", method = RequestMethod.GET)
    public String AMET_PIIRIPUNKTISController.show(@PathVariable("amet_piiripunktis_id") Long amet_piiripunktis_id, Model uiModel) {
        addDateTimeFormatPatterns(uiModel);
        uiModel.addAttribute("amet_piiripunktis", AMET_PIIRIPUNKTIS.findAMET_PIIRIPUNKTIS(amet_piiripunktis_id));
        uiModel.addAttribute("itemId", amet_piiripunktis_id);
    ...
    @RequestMapping(value = "/{amet_piiripunktis_id}", params = "form", method = RequestMethod.GET)
    public String AMET_PIIRIPUNKTISController.updateForm(@PathVariable("amet_piiripunktis_id") Long amet_piiripunktis_id, Model uiModel) {
        uiModel.addAttribute("AMET_PIIRIPUNKTIS", AMET_PIIRIPUNKTIS.findAMET_PIIRIPUNKTIS(amet_piiripunktis_id));
        addDateTimeFormatPatterns(uiModel);
        return "amet_piiripunktiss/update";
    }
    
    @RequestMapping(value = "/{amet_piiripunktis_id}", method = RequestMethod.DELETE)
    public String AMET_PIIRIPUNKTISController.delete(@PathVariable("amet_piiripunktis_id") Long amet_piiripunktis_id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        AMET_PIIRIPUNKTIS.findAMET_PIIRIPUNKTIS(amet_piiripunktis_id).remove();
        uiModel.asMap().clear();
    ...
    void AMET_PIIRIPUNKTISController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("AMET_PIIRIPUNKTIS_alates_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("AMET_PIIRIPUNKTIS_kuni_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("AMET_PIIRIPUNKTIS_avatud_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("AMET_PIIRIPUNKTIS_muudetud_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("AMET_PIIRIPUNKTIS_suletud_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
