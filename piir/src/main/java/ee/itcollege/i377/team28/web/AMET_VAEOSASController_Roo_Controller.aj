...
privileged aspect AMET_VAEOSASController_Roo_Controller {
    ...
    public String AMET_VAEOSASController.create(@Valid AMET_VAEOSAS AMET_VAEOSAS, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        return "redirect:/amet_vaeosass/" + encodeUrlPathSegment(AMET_VAEOSAS.getAmet_vaeosas_id().toString(), httpServletRequest);
    }
    ...
    @RequestMapping(value = "/{amet_vaeosas_id}", method = RequestMethod.GET)
    public String AMET_VAEOSASController.show(@PathVariable("amet_vaeosas_id") Long amet_vaeosas_id, Model uiModel) {
        addDateTimeFormatPatterns(uiModel);
        uiModel.addAttribute("amet_vaeosas", AMET_VAEOSAS.findAMET_VAEOSAS(amet_vaeosas_id));
        uiModel.addAttribute("itemId", amet_vaeosas_id);
    ...
    @RequestMapping(value = "/{amet_vaeosas_id}", params = "form", method = RequestMethod.GET)
    public String AMET_VAEOSASController.updateForm(@PathVariable("amet_vaeosas_id") Long amet_vaeosas_id, Model uiModel) {
        uiModel.addAttribute("AMET_VAEOSAS", AMET_VAEOSAS.findAMET_VAEOSAS(amet_vaeosas_id));
        addDateTimeFormatPatterns(uiModel);
        return "amet_vaeosass/update";
    }
    
    @RequestMapping(value = "/{amet_vaeosas_id}", method = RequestMethod.DELETE)
    public String AMET_VAEOSASController.delete(@PathVariable("amet_vaeosas_id") Long amet_vaeosas_id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        AMET_VAEOSAS.findAMET_VAEOSAS(amet_vaeosas_id).remove();
        uiModel.asMap().clear();
