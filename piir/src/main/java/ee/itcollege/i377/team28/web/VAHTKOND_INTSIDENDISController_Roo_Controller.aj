...
privileged aspect VAHTKOND_INTSIDENDISController_Roo_Controller {
    ...
    public String VAHTKOND_INTSIDENDISController.create(@Valid VAHTKOND_INTSIDENDIS VAHTKOND_INTSIDENDIS, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        return "redirect:/vahtkond_intsidendiss/" + encodeUrlPathSegment(VAHTKOND_INTSIDENDIS.getVahtkond_intsidendis_id().toString(), httpServletRequest);
    }
    ...
    public String VAHTKOND_INTSIDENDISController.show(@PathVariable("vahtkond_intsidendis_id") Long vahtkond_intsidendis_id, Model uiModel) {
        addDateTimeFormatPatterns(uiModel);
        uiModel.addAttribute("vahtkond_intsidendis", VAHTKOND_INTSIDENDIS.findVAHTKOND_INTSIDENDIS(vahtkond_intsidendis_id));
    ...
    public String VAHTKOND_INTSIDENDISController.updateForm(@PathVariable("vahtkond_intsidendis_id") Long vahtkond_intsidendis_id, Model uiModel) {
        uiModel.addAttribute("VAHTKOND_INTSIDENDIS", VAHTKOND_INTSIDENDIS.findVAHTKOND_INTSIDENDIS(vahtkond_intsidendis_id));
        addDateTimeFormatPatterns(uiModel);
        return "vahtkond_intsidendiss/update";
    }
    ...
    public String VAHTKOND_INTSIDENDISController.delete(@PathVariable("vahtkond_intsidendis_id") Long vahtkond_intsidendis_id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        VAHTKOND_INTSIDENDIS.findVAHTKOND_INTSIDENDIS(vahtkond_intsidendis_id).remove();
        uiModel.asMap().clear();
